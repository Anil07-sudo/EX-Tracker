...
export async function updateExpense(req, res) {
  ...
  try {
    ...
    const upadtedExpense = await expenseModel.findOneAndUpdate(
      { _id: id, userId },
      { description, amount },
      { new: true }
    );
    ...
    res.json({
      success: true,
   message:"Expense updated successfully.",date: upadtedExpense
    });
...
// to download the expense data in an excel sheet
