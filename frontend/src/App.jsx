...
const API_URL = "https://ex-tracker-8jy5.vercel.app/api";
...
const persistAuth = (userObj, tokenStr, remember = false) => {
  try {
    if (remember) {
      // Save in localStorage (persistent login)
      ...
      // Save in sessionStorage (temporary login)
...
useEffect(() => {
  ...
  const loadUser = async () => {
    try {
      ...
      const storedUser = JSON.parse(localUserRaw || sessionUserRaw || "null");
...
<Route element={
  <ProtectedRoute user={user}><Layout user={user} onLogout={handleLogout} 
