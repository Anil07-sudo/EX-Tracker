...
const Signup = ({ API_URL = "https://ex-tracker-x9el.vercel.app", onSignup }) => {
...
const persistAuth = (profile, token, rememberMe = false) => {
...
<p className={signupStyles.headerSubtitle}>
  Join ExpenseTracker to manage your finances easily.
</p>
      </div>
