...
import { ArrowDown, ArrowUp, Car, ChevronDown, ChevronUp, Clock, CreditCard, DollarSign, Gift, Home, IndianRupee, Info, PieChart, PiggyBank, RefreshCw, ShoppingCart, TrendingUp, Utensils, Zap } from 'lucide-react';
import { Outlet } from 'react-router-dom';
import axios from "axios";
// const API_BASE = "http://localhost:4000/api";
const API_BASE = "https://ex-tracker-8jy5.vercel.app/api";
...
// to fetch the transcation coming from server side
...
<div className={styles.statCards.iconContainer("orange")}>
  <ArrowDown className={styles.statCards.icon("ornage")} />
</div>
 </div>
      <p className={styles.statCards.cardFooter}>
    ...
    <div className={styles.cards.base}>
      ...
      <div className={styles.cards.header}>
        ...
        <h3 className={styles.cards.title}>
          <TrendingUp className="w-6 h-6 text-teal-500 inline mr-2" />
         Financial Overview
